            ...
            <main className="pt-40 pb-24 px-6 md:px-24 max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                    ...
                    <div className="lg:col-span-8 space-y-12">
                        {/* Product 1 */}
                        <div className="flex flex-col md:flex-row gap-8 items-start pb-12 border-b border-outline-variant/15">
                            <div className="w-full md:w-48 aspect-square bg-surface-container-highest rounded-xl overflow-hidden">
