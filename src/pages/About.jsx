            ...
            <section className="pb-32 px-6">
                <div className="max-w-5xl mx-auto arctic-gradient rounded-xl p-16 text-center relative overflow-hidden bg-noise">
                    <div className="relative z-10">
                        ...
                        <Link className="inline-flex items-center gap-3 bg-white text-primary px-10 py-5 rounded-full font-label text-sm uppercase tracking-widest font-bold hover:scale-105 transition-transform duration-300" to="/coleccion">
                            {t('about_cta_btn')}
